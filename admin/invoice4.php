	...
	<head>
		...
		<style>
			.invoice-box {
				...
				margin: auto;
				padding: 15px 15px; /* Adjust padding (top/bottom remains the same, reduce right/left) */
							...
							<div id="element" style="width:100%;">
                        		<div class="invoice-box">
                        						...
                        						<table>
                        							<tr>
                        								...
                        								<td style="padding-bottom: 2px; width: 60%;">
                        									...
                        									Guttahalli Circle Malleshwaram, Bangalore-560 003.
                        								</td>
                        							</tr>
                        						</table>
                        					</td>
                        						...
                        						<table>
                        							<tr>
                        								...
                        								<td style="padding-bottom: 2px;">
                        									...
                        									<b>Patient Contact Number :</b> <?php echo "$patientNumber";?>
                        								</td>
                        							</tr>
                        						</table>
                        					</td>
                                    ...
                                    ?>
										...
										<p><small>Signed and Seal :</small><br/> <b>VASAVI HEALTH CARE, HONGIRANA TRUST (R)</b></p>
										</td></tr>
                        			</table>
                        			<!--hr>
