...
<html lang="en">
	<head>
		<title>Treatment reports | HMS</title>
				...
				<div class="main-content" >
					<div class="wrap-content container" id="container">
						...
						<section id="page-title">
							<div class="row">
								<div class="col-sm-8">
									<h1 class="mainTitle">Treatment  | Reports</h1>
																	</div>
								<ol class="breadcrumb">
									<li>
										<span>Treatment </span>
										...
										<div class="col-lg-8 col-md-12">
											<div class="panel panel-white">
												<div class="panel-heading">
													<h5 class="panel-title">Treatment  Reports</h5>
												</div>
												<div class="panel-body">
									
													<form role="form" method="post" action="ajax-treatment-reports.php">
