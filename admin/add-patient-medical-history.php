...
if(strlen($_SESSION['id']==0)) {
 header('location:logout.php');
    ...
    if (isset($_POST['submit'])) {
        ...
        $doctor = $_POST['doctor'];
        $vid = $_GET['viewid'];
        $sql = "INSERT INTO `patients_medical_history`(`patients_id`,`doctor`, `note`, `url1`, `url2`, `url3`, `url4`, `url5`) VALUES('$vid','$doctor','$note','TAB','','','','')";
        ...
        if ($results_insert) {
            ...
            for ($i = 1; $i <= 5; $i++) {
                ...
                if (isset($_FILES[$inputName]) && !empty($_FILES[$inputName]['name'])) {
                    ...
                    $basename   = "patients_medical_history_" . $last_id . "_file_" . $i . "." . $extension;
                    $destination  = "uploads/" . $basename;
                    $url_path = $destination;

                    if (move_uploaded_file($_FILES[$inputName]['tmp_name'], $destination)) {
                        $query_update = "UPDATE patients_medical_history SET url$i='$url_path' WHERE id = '$last_id';";
            ...
            if (empty($msg)) {
				...
				echo "<script>alert('Patient Medical History details and files uploaded successfully.');</script>";
				echo "<script>window.location.href = 'manage-patient-medical-history.php?id=" . $vid . "'</script>";
...
<html lang="en">
	<head>
		<title>Admin | Add  Patient Medical History</title>
				...
				<div class="main-content" >
					<div class="wrap-content container" id="container">
						...
						<section id="page-title">
							<div class="row">
								<div class="col-sm-8">
									<h1 class="mainTitle">Admin | Add  Patient Medical History</h1>
										...
										<div class="col-lg-8 col-md-12">
											<div class="panel panel-white">
												<div class="panel-heading">
													<h5 class="panel-title">Add  Patient Medical History</h5>
												</div>
