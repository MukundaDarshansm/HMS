...
<html lang="en">
	<head>
		<title>Invoice reports | Admin</title>
				...
				<div class="main-content" >
					<div class="wrap-content container" id="container">
						...
						<section id="page-title">
							<div class="row">
								<div class="col-sm-8">
									<h1 class="mainTitle">Invoice  | Reports</h1>
																	</div>
								<ol class="breadcrumb">
									<li>
										<span>Invoice </span>
										...
										<div class="col-lg-8 col-md-12">
											<div class="panel panel-white">
												<div class="panel-heading">
													<h5 class="panel-title">Invoice  Reports</h5>
												</div>
												<div class="panel-body">
									
													<form role="form" method="post" action="ajax-invoice-reports.php">
													...
													<div class="form-group">
															...
															<select name="payment"  id="payment" class="form-control">
																...
																<?php
																	$payment_query = mysqli_query($con, "SELECT * FROM setting_payment");
