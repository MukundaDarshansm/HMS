                        		...
                        		<div class="invoice-box">
                                    ...
                                    <?php
                                        ...
                                        if (isset($_GET['View']) && isset($_GET['id'] )) {
                                            ...
                                            $itemQuery = mysqli_query($con, "SELECT * FROM patients_item WHERE vist_id='$visitId' and patients_id='$patientId'");
                                            $count = 1;
                                            $totalCost = 0;
...
$(document).ready(function() {
    ...
    function printContent() {
        ...
        if (printWindow) {
            printWindow.document.write('<html><head><title>Print</title></head><body style="font-size: 8px; margin-left: 2rem;">' + block1Content + '</body></html>');
