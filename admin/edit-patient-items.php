...
if (empty($_SESSION['id'])) {
    ...
    if (isset($_GET['id'])) {
        ...
        if (isset($_POST['submit'])) {
            $note = $_POST['note'];
			$doctor = $_POST['doctor'];
            $sql = "UPDATE patients_history SET note='$note', doctor='$doctor',url='TAB' WHERE id='$did'";
            ...
            if ($results_insert) {
                if (isset($_FILES["fileInput"]) && !empty($_FILES["fileInput"]["name"])) {
                    ...
                    $basename   = "patients_history_" . $did . "_file" . "." . $extension; // Adjust filename here
                    $destination  = "uploads/" . $basename;
                    $url_path = $destination; // Adjust path here
                    if (move_uploaded_file($_FILES["fileInput"]["tmp_name"], $destination)) {
                        $query_update = "UPDATE patients_history SET url='$url_path' WHERE id = '$did';";
                        $url_update = mysqli_query($con, $query_update);
                        if ($url_update) {
                            $msg = "User details and file uploaded successfully.";
                        } else {
                            $msg = "User details updated, but file upload failed.";
                        }
                    } else {
				...
				<div class="main-content" >
					<div class="wrap-content container" id="container">
						...
						<section id="page-title">
							<div class="row">
								<div class="col-sm-8">
									<h1 class="mainTitle">Admin | Edit Patient Visit History Details</h1>
								</div>
								<ol class="breadcrumb">
									<li>
										<span>Admin</span>
											...
											<select name="doctor" class="form-control">
												...
												?>
													...
													<div class="form-group">
														...
														<div class="form-group">
															<label for="fileInput"> Attachments<span >*</span>:</label>
